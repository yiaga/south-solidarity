    ...
    sessions: [
      {
        ...
        facilitators: [{ name: 'TBD' }, { name: 'Yiaga Africa' }, { name: 'OSF' }],
      },
      {
        time: '09:00-10.00am',
        ...
        facilitators: [{ name: 'Cheryl Akinyi', affiliation: 'Moderator' }],
      },
  ...
  'Day 3': {
    ...
    sessions: [
      ...
      { time: '09:15am-9:30am', title: 'Reflections from Cultural Visit to Robben Island', facilitators: [{ name: 'Collective Recap' }] },
      {
        ...
        facilitators: [{ name: 'Tessa Dooms (Session 1)' }, { name: 'Cynthia Mbamalu (Session 2)' }, { name: 'Session 3 & 4: TBD' }],
      },
      { time: '10:30am-10:35am', title: 'Music Performance', facilitators: [{ name: 'TBD' }] },
      {
        ...
        speakers: [{ name: 'Brian Kagoro' }, { name: 'Kumi Naidoo' }, { name: 'Zaha Lucy', affiliation: 'End Femicide, Kenya' }, { name: 'TBD' }],
        facilitators: [{ name: 'Moderator: TBD' }],
      },
