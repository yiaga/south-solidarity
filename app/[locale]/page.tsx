...
// FIX: Removed 'async' keyword since the function is synchronous.
...
// FIX: Removed the 'async' keyword entirely since all logic is synchronous.
// This eliminates the source of the Next.js sync-dynamic-apis warning.
        ...
        <div className="py-24 text-black">
          <Wrapper>
            ...
            <Link href="/resources" className="inline-block">
              <Buttton size="md" variant="secondary" className="text-white bg-green-600 hover:bg-green-700">
                {t('pact_button')}
              </Buttton>
            </Link>
          </Wrapper>
