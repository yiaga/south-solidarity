...
const sessionsData = [
  ...
  },
  {
    ...
    description:
      "A TED-style session for movement leaders to share powerful stories of emancipation, moments of courage and insights from organising on the frontlines. This session seeks to inspire, provoke and mobilize action.",
...
export default function WatchSessionClient() {
  return (
